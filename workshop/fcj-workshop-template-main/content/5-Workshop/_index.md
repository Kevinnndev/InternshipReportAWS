...
This section documents the video localization platform I built during the internship. The system supports subtitle extraction, translation, voice generation, and final video rendering so multilingual video processing can be handled more consistently.

The content follows the actual project structure in this repository, covering the backend services, AI/ML pipeline, frontend application, and deployment flow I worked on during the project.

## What the system does

The system documented in this section can:
