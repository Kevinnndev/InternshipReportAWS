...
In this module, I focused on the following areas:
...
- [Deployment demo video](https://drive.google.com/file/d/1pjXF8gTCsoc7X5n-5nWTakl2H9w0N4Zd/view)
...
aws ecs create-service \
    ...
    --desired-count 2 \
    --launch-type FARGATE \
    --network-configuration "awsvpcConfiguration={subnets=[subnet-your-private-subnet-id],securityGroups=[sg-your-ecs-security-group]}" \
    --region ap-southeast-2
```
...
aws rds create-db-instance \
    ...
    --vpc-security-group-ids sg-your-rds-security-group \
...
aws secretsmanager create-secret \
    ...
    --secret-string '{"AWS_ACCESS_KEY_ID":"your-access-key-id","AWS_SECRET_ACCESS_KEY":"your-secret-access-key"}' \
    --region ap-southeast-2
```
