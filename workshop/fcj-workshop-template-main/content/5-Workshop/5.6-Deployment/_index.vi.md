...
Trong module này, tôi tập trung vào các nội dung sau:
...
- [Video demo triển khai hệ thống](https://drive.google.com/file/d/1pjXF8gTCsoc7X5n-5nWTakl2H9w0N4Zd/view)
...
aws secretsmanager create-secret \
    ...
    --secret-string '{"gemini_key":"your-gemini-api-key","elevenlabs_key":"your-elevenlabs-api-key"}' \
    --region ap-southeast-2
```
